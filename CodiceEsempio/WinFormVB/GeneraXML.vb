...
Public Class GeneraXML
    ...
    Private Function genera_xml(percorso As String, nome_file As String) As Boolean
        ...
        Try
            ' istanzia la classe
            Dim nodoPrincipale As New FatturaElettronicaXMLNodes()
            ' ------------------------------------------------------------------------------------------
            ...
            xmlAttributeOverrides.Add(GetType(FatturaElettronicaXMLNodes), myxmlAttribute)
            ...
            xmlAttributeOverrides.Add(GetType(FatturaElettronicaXMLNodes), "FatturaElettronicaHeader", emptyNsAttribute)
            xmlAttributeOverrides.Add(GetType(FatturaElettronicaXMLNodes), "FatturaElettronicaBody", emptyNsAttribute)
